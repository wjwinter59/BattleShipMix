...
/* 
    Grid is obsolete, niet nodig. gewoon uitgaan van het feit dat de schepen weten waar ze zijn.
    dan heb je alle info die nodig is om vrije plaatsen te vinden of niet 
*/
/// <summary>
